...
def recognize(image_path, weights_path, char_dict_path, ord_map_dict_path,output_path):
    ...
    with tf.Session(config=sess_config) as sess2:
    #with sess.as_default():
        ...
        saver2.restore(sess=sess2, save_path=model_file)
        ...
        for index, pdf_image_text_area in enumerate(pdf_image_text_areas):
            ...
            preds = sess2.run(decodes, feed_dict={inputdata: [pdf_image_text_area]})
            ...
            # image_name=os.path.split(image_path)[1]#12_power_img_43_box.jpg
...
if __name__ == '__main__':
    ...
    #detect images
    recognize(
        image_path='data/output/EAST/43_power_img_2_box.jpg',
